const galleryItems = [
    { id: 1, path: 'images/1greenland.png', description: 'On our way to Europe, over the southern tip of Greenland', likes: 0 },
    ...
    { id: 8, path: 'images/8rota.png', description: 'Radio interview in Chania, Greece', likes: 0 },
    { id: 9, path: 'images/9rota.png', description: 'Who gave Mo a grenade launcher again?! Rota, Spain', likes: 0 }
];
